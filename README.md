...
**[View the interactive dashboard + data story on Tableau Public →](https://public.tableau.com/views/E-commercepolished/Story1?:language=en-US&:display_count=n&:origin=viz_share_link)**  ·  **SQL files: `PORTFOLIO_DATABASE.sql`, `portfolio11.sql`** (in this repo)
